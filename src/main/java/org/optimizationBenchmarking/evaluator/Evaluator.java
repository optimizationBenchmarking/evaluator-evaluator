...
import org.optimizationBenchmarking.evaluator.evaluation.definition.io.EvaluationXML;
import org.optimizationBenchmarking.evaluator.evaluation.spec.IEvaluationBuilder;
import org.optimizationBenchmarking.evaluator.evaluation.spec.IEvaluator;
...
public final class Evaluator extends ToolSuite implements IEvaluator {
  ...
  public static final String PARAM_INPUT_DRIVER = (IOTool.INPUT_PARAM_PREFIX
      + "Driver"); //$NON-NLS-1$
  ...
  public static final String PARAM_EVALUATION_SETUP = (EvaluationXML.PARAM_EVALUATION_PREFIX
      + EvaluationXML.PARAM_EVALUATION_SUFFIX);
