...
import org.optimizationBenchmarking.evaluator.data.impl.ref.Parameter;
...
import org.optimizationBenchmarking.evaluator.evaluation.definition.data.EvaluationModuleEntry;
import org.optimizationBenchmarking.evaluator.evaluation.definition.data.EvaluationModules;
import org.optimizationBenchmarking.evaluator.evaluation.definition.data.EvaluationModulesBuilder;
import org.optimizationBenchmarking.evaluator.evaluation.definition.io.EvaluationXMLInput;
import org.optimizationBenchmarking.evaluator.evaluation.impl.abstr.DocumentDriverOutput;
import org.optimizationBenchmarking.evaluator.evaluation.impl.abstr.StructuredIOInput;
...
/** The evaluation job */
final class _Evaluation extends _EvaluationSetup
  ...
  private final void __loadModules(final Configuration config,
    ...
    if (input.areSourcesDefined(config)) {
      ...
      for (final EvaluationModuleEntry entry : modules.getEntries()) {
